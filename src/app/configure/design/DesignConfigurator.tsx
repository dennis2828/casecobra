  ...
  async function saveConfiguration(){
    try{
      ...
      await startUpload([file], {configId});
        ...
        toast({title:"Something went wrong!", description:"There was a problem saving your config, please try again.", variant:"destructive"});
      }
  }
    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      <div ref={containerRef} className="relative h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
          ...
          <div className="absolute z-40 inset-0 left-[3px] top-px right-[3px] bottom-px rounded-[32px] shadow-[0_0_99999px_rgba(229,231,235,0.6)]" />
          <div
            className={cn(
        ...
        <Rnd
          ...
          onResizeStop={(_,__, ref, ___, {x,y})=>{
            setRenderedDimension({height: parseInt(ref.style.height.slice(0, -2)), width: parseInt(ref.style.width.slice(0,-2))});
            setRenderedPosition({x,y});
          }}
          lockAspectRatio
        ...
        <div className="w-full px-8 h-16 bg-white">
            ...
            <div className="w-full h-full flex justify-end items-center">
              <div className="w-full flex gap-6 items-center">
                  ...
                  <Button isLoading={isPending} disabled={isPending} loadingText="Saving" size="sm" className="w-full" onClick={()=>saveConfig({
                    configId,
